...
const dogMaria = dogs.find((dog) => dog.owners.includes("Marina"));

// console.log(
//   `Собака Марины ест слишком ${
//     dogMaria.curFood > dogMaria.recomendedFood ? "много" : "мало"
//   }`
// );
...
// console.log(`${ownerEatTooMuch.join(" и ")} собаки едят слишком много`);
// console.log(`${ownerEatTooLittle.join(" и ")} собаки едят слишком мало`);
